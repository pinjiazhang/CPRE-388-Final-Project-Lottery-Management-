...
public class History_Process_Pl5 extends BaseAdapter {
    ...
    public History_Process_Pl5(Context context, JSONArray j) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        History_Process_Pl5.ViewHolder holder;
        if (view == null) {
            view = View.inflate(context, R.layout.history_data_pl5, null);
            holder = new History_Process_Pl5.ViewHolder(view);
            view.setTag(holder);
        } else {
            holder = (History_Process_Pl5.ViewHolder) view.getTag();
        }
