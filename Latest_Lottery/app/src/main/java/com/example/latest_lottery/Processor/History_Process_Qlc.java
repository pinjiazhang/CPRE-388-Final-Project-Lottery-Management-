...
public class History_Process_Qlc extends BaseAdapter {
    ...
    public History_Process_Qlc(Context context, JSONArray j) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        History_Process_Qlc.ViewHolder holder;
        if (view == null) {
            view = View.inflate(context, R.layout.history_data_qlc, null);
            holder = new History_Process_Qlc.ViewHolder(view);
            view.setTag(holder);
        } else {
            holder = (History_Process_Qlc.ViewHolder) view.getTag();
        }
        ...
        try {
            ...
            holder.blue.setText(j.getString("sp"));
